...
export const ROOM_ANCHORS: Record<RoomType, RoomAnchor[]> = {
  bedroom: [
    ...
    { id: 'chair_front', x: 3.65, y: 6.85, slotType: 'floor', footprintW: 2, footprintH: 2, zIndex: 6 },
  ...
  gym: [
    ...
    { id: 'gym_floor_g', x: 3.65, y: 6.85, slotType: 'floor', footprintW: 2, footprintH: 2, zIndex: 6 },
