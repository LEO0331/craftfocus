...
export const ROOM_ANCHORS: Record<RoomType, RoomAnchor[]> = {
  ...
  gym: [
    { id: 'gym_floor_a', x: 0.9, y: 4.9, slotType: 'floor', footprintW: 2, footprintH: 2, zIndex: 5 },
    { id: 'gym_floor_b', x: 1.9, y: 5.7, slotType: 'floor', footprintW: 2, footprintH: 2, zIndex: 6 },
    { id: 'gym_floor_c', x: 3, y: 3, slotType: 'floor', footprintW: 2, footprintH: 2, zIndex: 5 },
    { id: 'gym_floor_d', x: 5.1, y: 4.4, slotType: 'floor', footprintW: 2, footprintH: 2, zIndex: 6 },
